...
// Returns the private 'App\Repository\ComptBancaireRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ComptBancaireRepository.php';

return $this->privates['App\\Repository\\ComptBancaireRepository'] = new \App\Repository\ComptBancaireRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
