...
// Returns the private 'App\Repository\RetraitRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/RetraitRepository.php';

return $this->privates['App\\Repository\\RetraitRepository'] = new \App\Repository\RetraitRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
